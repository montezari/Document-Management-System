                        ...
                        <form action="#" class="alert alert-success alert-borderless">
                            <div class="input-group">
                                <div class="input-cont">
                                    <input type="text" placeholder="Document Name Keyword..." class="form-control"/>
                                </div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="easy-pie-chart">
											...
											Trafic <i class="icon-arrow-right"></i>
											</a>
										</div>
									</div>
								...
								<div class="actions">
									<div class="btn-group">
										...
										<div class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
											...
											<label><input type="checkbox" checked=""/> Technical</label>
											<label><input type="checkbox"/> Customer Support</label>
											<label><input type="checkbox" checked=""/> HR</label>
											<label><input type="checkbox"/> MIS</label>
										</div>
									</div>
								</div>
							</div>
							<div class="portlet-body">
								<div class="scroller" style="height: 85px;" data-always-visible="1" data-rail-visible="0">
									<ul class="feeds">
										<li>
											<div class="col1">
												<div class="cont">
						...
						<div class="portlet light tasks-widget">
							...
							<div class="portlet-body">
								<div class="task-content">
									<div class="scroller" style="height: 278px;" data-always-visible="1" data-rail-visible1="1">
										<!-- START TASK LIST -->
										<ul class="task-list">
											<li>
